...
interface LeoMadeirasTableProps {
  ...
  onToggleAtivo: (empresaId: string, novoAtivo: boolean) => void
}

export function LeoMadeirasTable({ empresas, onOpenUsuarios, onOpenModulos, onEdit, onDelete, onToggleAtivo }: LeoMadeirasTableProps) {
          ...
          {empresas.map((emp) => {
            ...
            return (
              ...
              >
                ...
                {/* Column ATIVO (SIM / NÃO toggle badge) */}
                <td className="px-4 py-2 text-center">
                  <button
                    type="button"
